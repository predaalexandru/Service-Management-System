...
if(isset($_REQUEST['submitrequest'])) {
    ...
    if(($_REQUEST['requestinfo'] == "") || ($_REQUEST['requestdesc'] == "") || ($_REQUEST['requestername'] == "") || 
       ...
       $sql = "INSERT INTO submitrequest(request_info, request_desc, requester_name, requester_add1, requester_add2, requester_city, requester_state, requester_zip, requester_email, requester_mobile, requester_date)
       ...
       if($conn->query($sql) == TRUE) {
            ...
            $_SESSION['myid'] = $genid;
            echo "<script> location.href='submit_req_success.php'</script>";
       } else {
...
<div class="col-sm-9 col-md-10 mt-5"> <!-- Start Service Request Form -->
    <form class="mx-5" action="" method="POST">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" name="requestdesc" id="inputRequestDescription" rows="4" placeholder="Write Description"></textarea>
        ...
        <div class="form-group">
            ...
            <input class="form-control" type="text" name="requestername" id="inputName" placeholder="Ex. Alex">
        </div>
        <div class="form-row">
            <div class="form-group col-md-6">
                <label for="inputAddress"><strong>Address Line 1</strong></label>
                <input class="form-control" type="text" name="requesteradd1" id="inputAddress" placeholder="House No. 123">
            </div>
            <div class="form-group col-md-6">
                <label for="inputAddress2"><strong>Address Line 2</strong></label>
                <input class="form-control" type="text" name="requesteradd2" id="inputAddress2" placeholder="Railway Colony">
            </div>
        </div>
        <div class="form-row">
            <div class="form-group col-md-6">
                <label for="inputCity"><strong>City</strong></label>
                <input class="form-control" type="text" name="requestercity" id="inputCity">
            </div>
            <div class="form-group col-md-4">
                <label for="inputState"><strong>State</strong></label>
                <input class="form-control" type="text" name="requesterstate" id="inputState">
            </div>
            <div class="form-group col-md-2">
                <label for="inputZip"><strong>Zip</strong></label>
                <input class="form-control" type="text" name="requesterzip" id="inputZip" onkeypress="isInputNumber(event)">
            </div>
        </div>
        <div class="form-row">
            <div class="form-group col-md-6">
                <label for="inputEmail"><strong>Email</strong></label>
                <input class="form-control" type="email" name="requesteremail" id="inputEmail">
            </div>
            <div class="form-group col-md-2">
                <label for="inputMobile"><strong>Mobile</strong></label>
                <input class="form-control" type="text" name="requestermobile" id="inputMobile" onkeypress="isInputNumber(event)">
            </div>
            <div class="form-group col-md-2">
                <label for="inputDate"><strong>Date</strong></label>
                <input class="form-control" type="date" name="requesterdate" id="inputDate">
            </div>
        </div>
