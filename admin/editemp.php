...
<div class="col-sm-6 mt-5 mx-3 jumbotron">
    ...
    if(isset($_REQUEST['tehupdate'])) {
        ...
        if(($_REQUEST['empid'] == "") || ($_REQUEST['empName'] == "") || ($_REQUEST['empCity'] == "") || ($_REQUEST['empMobile'] == "") || ($_REQUEST['empEmail'] == "")) {
            ...
            $sql = "UPDATE technician SET empid = '$empid', empName = '$empName', empCity = '$empCity', empMobile = '$empMobile', empEmail = '$empEmail' WHERE empid = '$empid'";
    ...
    <form action="" method="POST">
        ...
        <div class="text-center">
            <button type="submit" class="btn btn-success" id="tehupdate" name="tehupdate">Update</button>
