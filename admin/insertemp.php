...
if(isset($_REQUEST['empadd'])) {
    if(($_REQUEST['empName'] == "") || ($_REQUEST['empCity'] == "") || ($_REQUEST['empMobile'] == "") || ($_REQUEST['empEmail'] == "")) {
        ...
        $sql = "INSERT INTO technician(empName, empCity, empMobile, empEmail) VALUES ('$empName', '$empCity', '$empMobile', '$empEmail')";
...
<div class="col-sm-6 mt-5 mx-3 jumbotron">
    ...
    <form action="" method="POST">
        ...
        <div class="text-center">
            <button type="submit" class="btn btn-success" id="empadd" name="empadd">Add</button>
